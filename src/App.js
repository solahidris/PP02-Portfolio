    ...
    <div className="bg-gray-800 min-h-[100vh]">
      ...
      <div className="px-[2rem] py-[5rem] lg:px-[8rem] bg-slate-700">
        <div className="flex flex-col lg:flex-row-reverse">
            {/* Macbook Pic */}
          <img src={macbookpic} className="mx-[2rem] lg:mx-[1rem] rounded-2xl aspect-square lg:w-[30%] lg:h-[30%] w-[100%] h:[100%] lg:self-center" alt="macpic" />
          <div className="lg:py-[2.5rem]">
            ...
            <div className="flex justify-center">
              ...
              {/* Employment History */}
            <div className="lg:px-[4rem] bg-slate-800/20 mx-[2rem] px-[1.5rem] py-[1rem] mt-[2rem] rounded-xl overflow-y-auto h-[30rem] lg:h-[100%]">
